...
const guideRoutes = [
  ...
  { path: "/guides/validate-okf-bundle/", label: "Validate OKF Bundle", priority: "0.75", lastmod: "2026-07-19" },
  ...
  { path: "/guides/how-to-create-okf-for-a-website/", label: "Create OKF for a Website", priority: "0.75", lastmod: "2026-07-19" },
  { path: "/guides/how-to-create-okf-for-api-docs/", label: "Create OKF for API Docs", priority: "0.75" },
  { path: "/guides/openapi-to-okf/", label: "OpenAPI to OKF", priority: "0.75", lastmod: "2026-07-19" },
...
export const publicRoutes = [
  ...
  { path: "/okf-folder-validator/", label: "OKF Folder Validator", priority: "0.85", lastmod: "2026-07-19" },
